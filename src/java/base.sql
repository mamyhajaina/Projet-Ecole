...
CREATE ROLE eco LOGIN password 'le';
ALTER DATABASE Page OWNER TO eco;
...
INSERT INTO etudiant VALUES(nextval('seq_etudiant'),'Rakoto','jean','3eme');
INSERT INTO etudiant VALUES(nextval('seq_etudiant'),'Rak','zaka','Terminal');
INSERT INTO etudiant VALUES(nextval('seq_etudiant'),'Rasoa','jeanette','seconde');
INSERT INTO etudiant VALUES(nextval('seq_etudiant'),'Kely','vola','seconde');
INSERT INTO etudiant VALUES(nextval('seq_etudiant'),'Bosse','aime','premier');
...
INSERT INTO administrateur(email,mdp) VALUES ('jean@gmail.com','jean');
